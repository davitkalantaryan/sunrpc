...
LINKAGE_HDR bool_t xdr_des_block();
...
extern LINKAGE_HDR struct opaque_auth _null_auth;
 ...
 *	int *aup_gids;
 */
LINKAGE_HDR AUTH *authunix_creat __P ((char *__machname, uid_t __uid,
				   gid_t __gid, int __len,
				   gid_t *__aup_gids));
LINKAGE_HDR AUTH *authunix_create_defaul __P ((void));
/// Modified Should be understood
//LINKAGE_HDR AUTH *authnone_creat __P ((void));
LINKAGE_HDR AUTH *authdes_create(void);
