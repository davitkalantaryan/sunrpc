...
WRPC_API_FAR bool_t pmap_set __P((u_long __program, u_long __version,
			     int __protocol, u_short __port));

WRPC_API_FAR bool_t pmap_unset __P((u_long __program, u_long __version));

WRPC_API_FAR struct pmaplist *pmap_getmaps __P((struct sockaddr_in *__address));
...
WRPC_API_FAR u_short pmap_getport __P((struct sockaddr_in *__address,
