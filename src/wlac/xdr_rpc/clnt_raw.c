...
static void		clntraw_abort(void* a_p);
static void		clntraw_geterr();
static bool_t		clntraw_freeres(CLIENT *, xdrproc_t, caddr_t);
static bool_t		clntraw_control(void * a_p, u_int a_i, char * a_cp);
static void		clntraw_destroy(void* a_p);
...
static void
clntraw_abort(void*a_p)
{
}

static bool_t
clntraw_control(void * a_p, u_int a_i, char * a_cp)
{
	return (FALSE);
}

static void
clntraw_destroy(void* a_p)
{
}
