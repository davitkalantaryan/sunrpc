...
static bool_t		svcraw_getargs(SVCXPRT *__xprt, xdrproc_t __xdr_args,caddr_t args_ptr);
static bool_t		svcraw_reply(SVCXPRT *__xprt, struct rpc_msg *__msg);
static bool_t		svcraw_freeargs(SVCXPRT *__xprt, xdrproc_t __xdr_args,caddr_t args_ptr);
